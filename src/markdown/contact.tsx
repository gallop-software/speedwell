...
<Section className="py-20 md:py-30 bg-accent4 relative">
  ...
  >
    <Column>
      ...
      <Paragraph>We'd love to hear about your design project. Whether you're looking to transform a single room or redesign your entire home, our team is here to bring your vision to life. Schedule a consultation at our Design District studio, give us a call, or send us a message. We typically respond within 24 hours and offer complimentary initial consultations for new clients.</Paragraph>
    </Column>
    <Column>
      <Grid
        cols="grid-cols-1"
...
export const metadata = {
  ...
  description: 'Get in touch with our interior design team for a complimentary consultation. Located in the Design District, we specialize in residential and commercial design projects.',
  slug: 'contact',
  ...
  openGraph: {
    ...
    description: 'Schedule your complimentary design consultation today. Our award-winning team is ready to transform your space.',
    image: {
