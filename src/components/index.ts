...
export { BackgroundGeometry2 } from './background-geometry-2'
export { BackgroundWallpaper1 } from './background-wallpaper-1'
...
export { Parallax, type ParallaxSpeed } from './parallax'
export { Blog } from './blog'
export { Contact1 } from './contact-1'
export { Footer } from './footer'
export { Footer2 } from './footer-2'
export { VimeoAutoPlayer } from './vimeo-auto-player'
