...
export const metadata = {
  ...
  lastModified: '2025-11-29T00:00:00Z',
  alternates: {
  ...
  structuredData: [
    ...
    },
    {
      ...
      description:
        'View our comprehensive portfolio of residential and commercial interior design projects showcasing exceptional craftsmanship, innovative solutions, and timeless aesthetic appeal across diverse styles and spaces',
      inLanguage: 'en',
      publisher: {
