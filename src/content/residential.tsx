      ...
      <Section className="py-30 bg-gradient-to-b from-body2 to-body-light">
        ...
        >
          ...
          <Column>
            ...
            <Quote>
              Laborum ipsum nulla veniam nulla quis aliqua minim laborum
              cupidatat
            </Quote>
            <Paragraph>
              ...
              consectetur non culpa et ullamco aute tempor adipiscing consequat
              et sint eiusmod ullamco non amet laborum excepteur in nisi commodo
            ...
            <Paragraph>
              ...
              mollit consectetur culpa officia pariatur minim cupidatat
              consequat incididunt enim nulla ipsum ullamco ipsum cillum
              occaecat deserunt ullamco occaecat do
            </Paragraph>
            <Paragraph>
        ...
        >
          ...
          <Column>
            ...
            <Paragraph>
              ...
              aute amet qui labore adipiscing velit minim veniam tempor
              incididunt amet dolor aliqua occaecat nisi culpa nostrud sit
              officia veniam ullamco ut occaecat dolore non quis elit
              exercitation officia labore cillum aliqua duis do consectetur anim
              velit magna nisi cillum qui excepteur sint ut qui enim est fugiat
              adipiscing aliquip
            </Paragraph>
            <Paragraph>
              Ea do lorem labore proident aliqua dolor labore et commodo velit
              non officia aliqua id et ea dolor veniam nostrud qui duis
              incididunt aute sunt ex duis occaecat quis amet sit ut dolor nisi
              fugiat laborum qui proident ex tempor irure cillum deserunt
              consectetur sit
            </Paragraph>
            <Paragraph>
              Voluptate cillum ut adipiscing sunt anim occaecat cillum tempor
              sed mollit ullamco enim nulla ea consectetur sunt excepteur velit
              aute incididunt voluptate nostrud exercitation nisi voluptate
              minim aliquip dolore aute dolor mollit ut reprehenderit lorem
              incididunt sit proident ut dolor nostrud dolore velit qui aute
              eiusmod nisi amet minim labore amet minim
            </Paragraph>
            <Buttons>
              <Button
                variant="primary"
        ...
        >
          ...
          <Column>
            ...
            <Paragraph>
              ...
              consequat fugiat anim dolore lorem veniam magna proident aliquip
              et laboris ex sit aliquip irure consequat duis aliqua quis esse
              enim magna voluptate ipsum enim elit cupidatat adipiscing
              reprehenderit consequat enim sunt fugiat sit irure in consectetur
              eiusmod proident excepteur reprehenderit
            </Paragraph>
            <Buttons>
              <Button
                variant="primary"
        ...
        >
          ...
          <Column>
            ...
            <Paragraph>
              ...
              enim magna sunt ullamco fugiat proident minim est officia sit
              minim nisi ad et sunt nostrud esse fugiat ad ipsum aliquip
              occaecat reprehenderit ullamco nisi mollit adipiscing consequat
              adipiscing
            </Paragraph>
            <Paragraph>
...
export const metadata = {
  ...
  description:
    'Pariatur minim culpa consequat ipsum culpa culpa deserunt ea anim ad tempor nulla quis amet elit adipiscing ut aliqua excepteur occaecat magna',
  keywords: [
    'donec rutrum congue',
    'leo eget malesuada',
    'rutrum congue leo',
    'alternative to donec rutrum',
    'natural leo eget malesuada',
    'congue leo rutrum',
    'rutrum congue near donec',
    'leo eget center donec',
    'malesuada rutrum congue',
    'donec leo eget rutrum',
    'natural congue malesuada',
    'leo rutrum congue',
    'malesuada suites donec',
  ],
  slug: 'eiusmod-tempor',
  ...
  openGraph: {
    ...
    description:
      'Sit voluptate laborum ea sint adipiscing ullamco ipsum nisi amet fugiat in aute occaecat occaecat voluptate id aute ipsum lorem ipsum esse',
    image: {
  ...
  twitter: {
    ...
    description:
      'Nostrud ad mollit fugiat adipiscing in elit non commodo est eiusmod anim id exercitation nisi proident incididunt labore veniam proident sed culpa',
