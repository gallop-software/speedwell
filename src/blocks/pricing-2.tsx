      ...
      <div className="relative">
        <div className="text-center mb-20">
          ...
          <Paragraph className="text-lg max-w-2xl mx-auto">
            From intimate gatherings to grand celebrations, we offer comprehensive planning packages designed to make your event stress-free and unforgettable.
          </Paragraph>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-1 flex flex-col relative border-t-4 border-accent2">
            <div className="mb-6">
              ...
              <p className="text-body-muted mb-4">Perfect for intimate celebrations</p>
            ...
            <ul className="space-y-3 mb-6 flex-grow text-sm">
              <li className="flex items-start gap-2">
                <Icon icon={checkIcon} className="w-5 h-5 text-accent2 mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <Icon icon={checkIcon} className="w-5 h-5 text-accent2 mt-0.5 flex-shrink-0" />
                <span className="text-body-dark">Vendor coordination (3 vendors)</span>
              </li>
              <li className="flex items-start gap-2">
                <Icon icon={checkIcon} className="w-5 h-5 text-accent2 mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <Icon icon={checkIcon} className="w-5 h-5 text-accent2 mt-0.5 flex-shrink-0" />
                <span className="text-body-dark">Day-of coordination (6 hours)</span>
              </li>
            </ul>
          ...
          <div className="bg-gradient-to-br from-accent to-accent/90 p-8 rounded-2xl shadow-2xl hover:shadow-3xl transition-all hover:-translate-y-2 relative flex flex-col scale-105 border-4 border-accent/20">
            ...
            <div className="mb-6">
              ...
              <p className="text-white/90 mb-4">For unforgettable celebrations</p>
              <div className="flex items-baseline">
            ...
            <ul className="space-y-3 mb-6 flex-grow text-sm">
              <li className="flex items-start gap-2">
                <Icon icon={checkIcon} className="w-5 h-5 text-white mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <Icon icon={checkIcon} className="w-5 h-5 text-white mt-0.5 flex-shrink-0" />
                <span className="text-white">Custom event design & styling</span>
              </li>
              <li className="flex items-start gap-2">
                <Icon icon={checkIcon} className="w-5 h-5 text-white mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <Icon icon={checkIcon} className="w-5 h-5 text-white mt-0.5 flex-shrink-0" />
                <span className="text-white">Full day-of coordination (12 hours)</span>
              </li>
            </ul>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-1 flex flex-col relative border-t-4 border-accent">
            ...
            <ul className="space-y-3 mb-6 flex-grow text-sm">
              ...
              <li className="flex items-start gap-2">
                <Icon icon={checkIcon} className="w-5 h-5 text-accent mt-0.5 flex-shrink-0" />
                <span className="text-body-dark">Custom decor & installations</span>
              </li>
              <li className="flex items-start gap-2">
                <Icon icon={checkIcon} className="w-5 h-5 text-accent mt-0.5 flex-shrink-0" />
