            ...
            <Column className="flex flex-col justify-center space-y-8">
              <div>
                ...
                <Paragraph className="text-lg max-w-xl">
                  From intimate ceremonies to grand celebrations, we bring your vision to life with meticulous attention to detail, creative flair, and seamless execution. Let us transform your special moments into cherished memories that last a lifetime.
                </Paragraph>
              </div>
              ...
              <div className="relative h-[500px] lg:h-[650px]">
                ...
                <div className="absolute top-1/3 left-1/4 z-30 bg-white px-6 py-4 rounded-full shadow-xl transform -rotate-6">
                  <div className="text-center">
                    <div className="font-accent text-sm text-accent mb-1">Award Winning</div>
                    <div className="text-xs text-body-dark/60">Event Planners</div>
                  </div>
                </div>
              </div>
            </Column>
