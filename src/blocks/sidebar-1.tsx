  ...
  return (
    <div className="space-y-6">
      ...
      <Paragraph>
        ...
        <SidebarLink componentId="demo2" title="Modern Style">
          Modern Style
        </SidebarLink>{' '}
        and{' '}
        <SidebarLink componentId="demo3" title="Color Theory">
          Color Theory
        </SidebarLink>
        .
      </Paragraph>
      ...
      <Paragraph>
        ...
        <SidebarLink componentId="demo4" title="Space Planning">
          Space Planning
        </SidebarLink>{' '}
      ...
      <Paragraph>
        Whether you prefer{' '}
        <SidebarLink componentId="demo5" title="Minimalist Design">
          Minimalist Design
        </SidebarLink>{' '}
        or{' '}
        <SidebarLink componentId="demo6" title="Bohemian Style">
          Bohemian Style
        </SidebarLink>
  ...
  return (
    <div className="space-y-6">
      ...
      <Paragraph>
        ...
        influence{' '}
        <SidebarLink componentId="demo1" title="Interior Design">
          Interior Design
        </SidebarLink>{' '}
        today.
      </Paragraph>
  ...
  return (
    <div className="space-y-6">
      ...
      <Paragraph>
        ...
        excess to focus on essential elements, creating peaceful and
        uncluttered spaces.
      </Paragraph>
