          ...
          <Columns reverseColumns={false}>
            <Column className="relative -mx-6">
              <Image
                ...
                lazy={false}
              />
              <Accent className="absolute hidden lg:block -bottom-10 lg:bottom-auto left-6 right-auto lg:-top-20 lg:-right-40 transform lg:text-right -rotate-12" textAlign="text-left">
                curated style
              </Accent>
            </Column>
