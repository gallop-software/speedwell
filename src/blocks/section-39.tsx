        ...
        >
          ...
          <Column className="flex flex-col justify-center">
            ...
            <Paragraph className="text-lg mb-6 leading-relaxed">
              ...
              art of botanical infusion, honoring techniques passed down through
              generations.
            </Paragraph>
            ...
            <Paragraph className="mb-8 text-body-contrast/70">
              ...
              We source our ingredients from family farms across three
              continents, ensuring only the most exceptional botanicals make
