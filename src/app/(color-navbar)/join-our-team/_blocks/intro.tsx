...
export default function Intro() {
  return (
    <Section className="relative py-30 overflow-hidden">
      <div className="absolute inset-0 opacity-30 sm:opacity-50 bg-repeat bg-left-top bg-[length:700px] bg-[url('https://speedwell-cdn.gallop.software/images/geometric-lg.jpg')]"></div>
      <div className="absolute inset-0 bg-gradient-to-r from-body to-transparent [background-image:linear-gradient(to_right,var(--color-body)_0%,rgb(255_255_255_/_0%)_100%),linear-gradient(to_bottom,var(--color-body)_0%,rgb(255_255_255_/_0%)_100%),linear-gradient(to_top,var(--color-body)_0%,rgb(255_255_255_/_0%)_70%)]"></div>
      <Accent
