export const metadata = {
  title: 'Contact Us',
  description: 'Contact Heartbeat Midwifery in Lubbock for midwifery services, birth center tours, and pregnancy care. Get in touch with our caring team today.',
  slug: 'contact',
