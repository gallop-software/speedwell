export const metadata = {
  title: 'Adipiscing id',
  description: 'Ut commodo est quis culpa velit et laboris quis consequat sed nulla cillum cillum aute aute lorem qui eiusmod sit ullamco ex',
  slug: 'contact',
  ...
  openGraph: {
    title: 'Deserunt quis',
    description: 'Consectetur deserunt eiusmod quis anim sed commodo mollit amet cillum eiusmod ea ut tempor amet ex quis ex qui adipiscing esse dolor',
    image: {
      url: '/images/birth-center.jpg',
      alt: 'Lorem excepteur cillum',
    },
...
<Section className="py-20 md:py-30 bg-body2 relative">
  ...
  >
    <Column className="mb-10">
      <Heading as="h1">Labore veniam</Heading>
      <Form>
        <FormInput
          name="emailSubject"
...
<Section className="py-20 md:py-30 bg-accent4 relative">
  ...
  >
    <Column>
      <Heading as="h2">Tempor est non</Heading>
      <Paragraph>Nulla sunt adipiscing duis lorem magna sint et irure aute aute dolor tempor occaecat sunt duis deserunt aliquip veniam fugiat laboris consequat pariatur in ut ea eiusmod fugiat commodo irure quis nulla dolore ipsum anim magna sint et excepteur ut ullamco proident deserunt ullamco nulla ipsum ex nisi consequat esse dolore dolor ullamco nostrud voluptate minim pariatur qui aliqua ea nisi aliquip dolore mollit labore dolor</Paragraph>
    </Column>
    <Column>
      <Grid
        cols="grid-cols-1"
