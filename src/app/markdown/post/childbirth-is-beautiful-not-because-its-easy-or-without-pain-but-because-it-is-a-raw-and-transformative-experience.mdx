export const metadata = {
  title: 'Est commodo dolor aute nisi ad adipiscing commodo irure deserunt esse ullamco dolor aliqua consequat eiusmod aliquip ex irure',
  description: 'Magna sunt et sed aliquip dolore ad dolore magna enim cillum ea minim id excepteur duis exercitation ea sint ex ad elit id ex lorem elit',
  date: '2024-11-27',
  ...
  openGraph: {
    title: 'Voluptate ut elit sed irure labore aliqua laborum proident adipiscing nisi labore laborum est veniam do amet tempor fugiat cillum tempor mollit',
    description: 'Id minim lorem occaecat nulla ullamco veniam pariatur veniam ex id dolore aliqua voluptate consequat aliqua proident ullamco ut aliqua quis et consequat lorem exercitation ipsum',
    image: {
