    ...
    <Columns reverseColumns>
      <Column className="relative -mx-6">
        <Image
          ...
          lazy={false}
        />
        <Accent className="absolute hidden lg:block -bottom-10 lg:bottom-auto left-6 lg:-top-20 lg:-left-40 transform -rotate-12">Culpa aliquip</Accent>
      </Column>
      <Column className="mx-auto max-w-2xl lg:max-w-7xl">
        <Heading
          as="h1"
          className="max-w-2xl"
        >Eiusmod aliquip ullamco ea</Heading>
  ...
  <Columns gap="gap-10 lg:gap-20">
    ...
    <Column>
      <Heading
        as="h2"
        id="services"
      >Sed reprehenderit pariatur</Heading>
  ...
  >
    ...
    <Column>
      <Heading
        as="h3"
        styleAs="h2"
      >Id veniam consequat consequat proident cupidatat duis sunt dolor</Heading>
  ...
  >
    ...
    <Column>
      <Heading
        as="h3"
        styleAs="h2"
      >Commodo adipiscing nisi incididunt</Heading>
  ...
  >
    ...
    <Column>
      <Heading
        as="h3"
        styleAs="h2"
      >Nulla ipsum sunt dolore amet</Heading>
  ...
  >
    ...
    <Column>
      <Heading
        as="h3"
        styleAs="h2"
      >Ad ut anim id pariatur</Heading>
      ...
      <Buttons>
        <Button
          ...
          iconPlacement="after"
        >Ipsum fugiat nisi laboris</Button>
      </Buttons>
    </Column>
  </Columns>
</Section>
  ...
  >
    ...
    <Column>
      <Heading
        as="h3"
        styleAs="h2"
      >Reprehenderit dolore fugiat aliqua id incididunt ullamco nisi ullamco</Heading>
  ...
  >
    ...
    <Column>
      <Heading
        as="h3"
        styleAs="h2"
      >Nisi esse reprehenderit eiusmod</Heading>
