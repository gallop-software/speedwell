    ...
    <Columns reverseColumns>
      <Column className="relative -mx-6">
        <Image
          ...
          lazy={false}
        />
        <Accent className="absolute hidden lg:block -bottom-10 lg:bottom-auto left-6 lg:-top-20 lg:-left-40 transform -rotate-12">Sunt ipsum</Accent>
      </Column>
      <Column className="mx-auto max-w-2xl lg:max-w-7xl">
        <Heading
          as="h1"
          className="max-w-2xl"
        >Tempor elit labore ad</Heading>
        ...
        <Buttons className="">
          <Button
            ...
            iconPlacement="after"
          >Elit irure tempor dolor sint in commodo</Button>
        </Buttons>
      </Column>
    </Columns>
  </div>
