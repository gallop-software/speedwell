export const metadata = {
  ...
  description: 'Read inspiring birth stories and testimonials from families served by Heartbeat Midwifery in Lubbock. Discover real experiences with our midwifery care.',
  slug: 'testimonials',
  featuredImage: '/images/birth-center.jpg',
  focusKeyword: 'midwifery testimonials',
