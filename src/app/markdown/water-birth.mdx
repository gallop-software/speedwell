export const metadata = {
  title: 'Water Birth in Lubbock',
  description: "Experience a gentle water birth in Lubbock—often called nature's epidural for its soothing, calming support during labor and delivery.",
  keywords: ['water birth in lubbock', 'water birth lubbock', 'lubbock water birth', 'water birth center lubbock', 'water birth midwife lubbock', 'hydrotherapy birth lubbock', 'natural water birth', 'water birth tub lubbock', 'water birthing center texas', 'home water birth lubbock', 'water delivery lubbock', 'gentle water birth', 'water birth near me'],
  slug: 'water-birth',
  featuredImage: '/images/img_0785-scaled0.jpg',
  focusKeyword: 'water birth in lubbock',
  ...
  openGraph: {
    ...
    image: {
      ...
      alt: 'Water Birth Services at Heartbeat Midwifery in Lubbock',
    },
  },
  twitter: {
    ...
    <Columns reverseColumns>
      <Column className="relative -mx-6">
        <Image
          ...
          alt="Water Birth in Lubbock - Heartbeat Midwifery"
          size="large"
          rounded="rounded-none"
          lazy={false}
        />
        <Accent className="absolute hidden lg:block -bottom-10 lg:bottom-auto left-6 lg:-top-20 lg:-left-40 transform -rotate-12">natural relief</Accent>
      </Column>
      <Column className="mx-auto max-w-2xl lg:max-w-7xl">
        <Heading
          ...
          className="max-w-2xl"
        >
          Gentle, Supported, and Empowering Birth Experiences
        </Heading>
        <Paragraph>At Heartbeat Midwifery, we believe birth is a sacred, deeply personal journey. Water birth offers a natural, evidence-supported way to create a calm and soothing environment for labor and delivery. Whether you choose to birth in one of our serene, spa-inspired tubs at our Lubbock birth center or in the comfort of your own home, we provide expert guidance and unwavering support to ensure your experience is both safe and empowering.</Paragraph>
        <Buttons className="">
          <Button
            href="#learn-more"
