export const metadata = {
  title: 'Elit consequat magna aliquip commodo ad',
  description: 'In proident ex ea nulla officia amet elit duis ad laborum voluptate laboris non ipsum fugiat sed voluptate voluptate qui',
  ...
  openGraph: {
    ...
    title: 'Laborum cupidatat dolor dolor amet do',
    description: 'Sit voluptate aliquip occaecat ut irure mollit tempor velit occaecat ipsum sunt ullamco id officia amet aliqua amet voluptate nulla',
    image: {
      url: '/images/img_0785-scaled0.jpg',
      alt: 'In ea duis amet amet adipiscing sunt cupidatat velit',
    },
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Sed labore ullamco aute amet duis',
    description: 'Exercitation excepteur tempor cillum do lorem mollit ad esse aliqua quis voluptate sed quis aute mollit dolore dolore occaecat ut',
