...
async function rewriteReadmeForLite() {
  ...
  try {
    ...
    const repoReplacements = [
      ...
      ['**🌐 Demo:** [speedwell.gallop.software](https://speedwell.gallop.software)', '**⚡ Demo:** [speedwell-lite.vercel.app](https://speedwell-lite.vercel.app)  \n**🌐 Pro Demo:** [speedwell.gallop.software](https://speedwell.gallop.software)'],
    ]
