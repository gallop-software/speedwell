...
│   │   │                      # kitchen-bath, meet-the-team, and more
...
│   ├── barlow/              # 13 families included — barlow,
│   ├── montserrat/          # montserrat, poppins, raleway,
│   ├── poppins/             # oswald, rubik, urbanist, and more
│   └── .../
├── _data/                    # Generated metadata — never edit by hand
│   ├── _blog.json           # Blog metadata (npm run blog)
...
- **Valtio** `2.3.2` - State management
- **Swiper** `12.1.4` - Modern slider/carousel
...
- **Vimeo Player** `2.30.4` - Video player integration
...
- **Next Third Parties** `16.2.6` - Third-party script optimization
...
- **Wrangler** `4.113.0` - Cloudflare CLI, used by the `cf:*` scripts
